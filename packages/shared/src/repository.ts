...
export interface ContentRepository {
  ...
  createTextFile(dirPath: string, desiredName: string, content?: string): Promise<string>;
  ...
  createImageFile(dirPath: string, desiredName: string, blob: Blob): Promise<string>;
